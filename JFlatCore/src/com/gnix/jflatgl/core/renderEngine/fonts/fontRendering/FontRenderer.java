...
import com.gnix.jflatgl.core.renderEngine.shaders.FontShader;
import com.gnix.jflatgl.core.renderEngine.shaders.StencilShader;
...
//		if (!text.getTextString().startsWith("FPS"))
